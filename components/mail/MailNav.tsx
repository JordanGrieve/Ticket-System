...
/**
 * Folders the design asks for that have no table behind them yet. Rendered as
 * genuinely disabled controls rather than links that go nowhere, and with no
 * count pill at all — a "0" here would read as "you have no starred mail",
 * which is a claim we cannot make.
 */
const UNBUILT_FOLDERS: { label: string; icon: IconName }[] = [
  { label: "Starred", icon: "star" },
  { label: "Labeled", icon: "label" },
